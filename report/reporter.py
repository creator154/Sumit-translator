...
# यहाँ SyntaxWarning को ठीक करने के लिए 'r' (raw string) जोड़ा गया है
account = fr"""{k}
 ____                             _               
    ...
    def report_channel(self):
        with self.client as client:
            ...
            try:
                ...
                print(f"{lrd}Username does not exist")
                return
            ...
            if self.method == "1":
                ...
                for _ in range(0, int(self.number)): 
                    ...
                    print(f"{lrd}[{lgn}+{lrd}] {gn}A Pornography report has been sent")
            elif self.method == "5":
                ...
                for _ in range(0, int(self.number)): 
                    ...
                    print(f"{lrd}[{lgn}+{lrd}] {gn}A Copyright report has been sent")
            elif self.method == "6":
